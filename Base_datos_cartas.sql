...
INSERT INTO estados (nombre_estado,descripcion,turnos) VALUES
('Depresión','Ve al pscicologo',2), ('Parálisis','La corriente te stunnea',3), ('Quemado','Usa proteccion solar a la proxima',1), ('Envenenado', 'Te va drenando vida',1), ('Cristalizado','La roca',2), ('Mojado','Duchita fria para empezar el dia',1), ('Moderado','Has sido banneano',3);
